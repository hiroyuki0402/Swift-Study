...
class FruitsViewModel {
    var fruitsDatas: [FruitsData] = []

    init() {
        self.fruitsDatas = TestData.testData()
    }

    func loadFruitsDatas() -> [FruitsData] {
        return fruitsDatas
    }

    func loadFruitsData(at index: Int) -> FruitsData {
        return fruitsDatas[index]
    }

    func fruitsDataCount() -> Int {
        return fruitsDatas.count
    }
}
...
class TestData {
    class func testData() -> [FruitsData] {
        return [
            .init(
                title: "ブルーベリー",
                headline: "ブルーベリーは世界中で非常に人気のある甘くて栄養価の高い果物です。",
                image: "blueberry",
                gradientColors: [.colorBlueberryLight, .colorBlueberryDark],
                description: """
                  ブルーベリーは青または紫のベリーを持つ多年生の花植物です。
                  ジャンルVacciniumのセクションCyanococcusに分類されます。
                  Vacciniumにはクランベリー、ビルベリー、ハックルベリー、マデイラブルーベリーも含まれます。
                  商業的に生産されているブルーベリー（野生のローブッシュと栽培されたハイブッシュの両方）はすべて北米原産です。
                  ハイブッシュの品種は1930年代にヨーロッパに導入されました。
                  ブルーベリーは通常、10センチメートル（3.9インチ）から4メートル（13フィート）の高さまでの大きさが異なる低木です。
                  ブルーベリーの商業生産において、ローレベルのブッシュで成長する小さな豆のサイズのベリーを持つ種は「ローブッシュブルーベリー」として知られています
                  （「ワイルド」と同義）、一方、より大きなベリーを持ち、より高いブッシュで栽培されている種は「ハイブッシュブルーベリー」として知られています。
                  カナダはローブッシュブルーベリーの主要生産国であり、アメリカはハイブッシュブルーベリーの世界供給の約40%を生産しています。

                  用途
                  ブルーベリーは新鮮な状態で販売されるか、IQFフルーツ、ピューレ、ジュース、乾燥または浸漬ベリーとして加工されます。
                  これらは、ジェリー、ジャム、ブルーベリーパイ、マフィン、スナック食品、または朝食シリアルへの添加物として消費者向け商品で使用されることがあります。
                  ブルーベリージャムはブルーベリー、砂糖、水、フルーツペクチンから作られます。ブルーベリーソースは、主要な材料としてブルーベリーを使用して調理される甘いソースです。
                  ブルーベリーワインは、ベリーの肉と皮から作られます。
                  それは発酵させてから熟成させます。通常、ローブッシュの品種が使用されます。

                  栄養素
                  ブルーベリーは炭水化物14％、タンパク質0.7％、脂肪0.3％、水分84％（表）で構成されています。
                  微量栄養素の量はほとんどありませんが、必須の食事ミネラルマンガン、ビタミンC、ビタミンK、食物繊維（表）の中等度のレベル（相対的な日常値）を含む。
                  一般的に、ブルーベリーの栄養素の含有量はDV（表）の低い割合です
                  。1回の摂取は、57kcalの比較的低いカロリー値と6のグリセミック負荷を提供します。
                  """,
                nutrition: ["240 kJ (57 kcal)","9.96 g","0.33 g","0.74 g","A, B1, B2, B3, B5, B6, B9, C, E, K","カルシウム, 鉄, マグネシウム, マンガン, リン, ナトリウム, 亜鉛"]
            ),
            .init(title: "イチゴ",
                  headline: "その特有の香り、赤い色、ジューシーな食感、甘さで広く評価されています。",
                  image: "strawberry",
                  gradientColors: [.colorStrawberryLight, .colorStrawberryDark],
                  description: """
                  ガーデンストロベリー(または単にイチゴ; Fragaria × ananassa)は、
                  イチゴとして知られるFragaria属の広く栽培されているハイブリッド種です。
                  この果物は、その特有の香り、鮮やかな赤色、ジューシーな食感、甘さで広く評価されています。
                  それは、生のまままたはジャム、ジュース、パイ、アイスクリーム、ミルクシェイク、チョコレートなどの調理済み食品として大量に消費されています。
                  人工のイチゴの風味や香りも、キャンディ、石鹸、リップグロス、香水、その他多くの製品で広く使用されています。植物学的な観点からは、イチゴはベリーではありません。
                  技術的には、それは集約付属果実であり、つまり、肉質の部分は植物の卵巣からではなく、卵巣を保持する器官から派生しています。果物の外側の各見かけ上の「種」(achene)は実際には花の卵巣の1つで、その中に種が入っています。
                  キュリナリーイチゴは、生で食べるほかに、冷凍したり、ジャムや保存食にしたり、乾燥させてシリアルバーなどの調理済み食品に使用することもできます。
                  イチゴやイチゴの風味は、イチゴミルク、イチゴアイスクリーム、イチゴミルクシェイク/スムージーやイチゴヨーグルトなどの乳製品に人気のある添加物です。
                  英国では、ウィンブルドンのテニス大会で「イチゴとクリーム」が人気のデザートとして消費されています。
                  メキシコでは、通常アイスクリームパーラーで利用可能なイチゴとクリームも基本のスナックです。
                  スウェーデンでは、ヨハネの日、または夏至の前夜としても知られる日に、イチゴが伝統的なデザートとして提供されます。
                  エリアによっては、イチゴのパイ、イチゴルバーブパイ、またはイチゴのショートケーキも一般的です。
                  ギリシャでは、イチゴに砂糖をかけて、ブランデーのMetaxaに浸けてデザートとして提供されることがあります。
                  イタリアでは、イチゴはさまざまなデザートやジェラートの風味付けとして一般的に使用されます。
                  フィンランドのノースサヴォニア地方のSuonenjokiは、イチゴで有名な小さな町で、そのため「イチゴの町」または「イチゴの首都」としても知られています。
                  夏には主にウクライナやロシアからの外国人が、イチゴ農場で働くためにSuonenjokiに来ます。
                  そのため、夏にはSuonenjokiがフィンランドで最も国際的な町となります。
                  7月にSuonenjokiで「Mansikkakarnevaalit」と呼ばれる「イチゴのカーニバル」というパーティーがあります。
                  栄養イチゴの1回分の摂取(100 g;イチゴには、achene（種）オイルに必要な不飽和脂肪酸が適度に含まれています。
                  """,
                  nutrition: ["136 kJ (33 kcal)","4.89 g","0.3 g","0.67 g","B1, B2, B3, B5, B6, B9, コリン, C, E, K","カルシウム, 鉄, マグネシウム, マンガン, リン, カリウム, ナトリウム, 亜鉛"]
                 )
            ,
            .init(
                title: "レモン",
                headline: "レモンは美味しいことは間違いないが、水に加えることで健康になるのか？",
                image: "lemon",
                gradientColors: [.colorLemonLight, .colorLemonDark],
                description: """
                レモン、Citruslimon、は、主に北東インドの南アジア原産の小さな常緑樹の種で、花のある植物のルタセア科に属しています。
                その果実は丸い形をしています。
                この木の楕円形の黄色い果実は、世界中で料理および非料理目的で使用されており、主にジュースが料理および掃除の用途で使われています。
                果肉と皮も料理や焼き菓子に使用されます。レモンのジュースは約5％から6％のクエン酸で、
                pHは約2.2で、酸っぱい味がします。
                レモンジュースの独特の酸っぱい味は、レモネードやレモンメレンゲパイなどの飲み物や食べ物の主要な成分としています。

                NUTRITION
                レモンはビタミンCの豊富な源であり、100gの基準量（表）で1日の摂取量の64％を提供します。
                他の必須栄養素の含有量は少ないです。
                レモンには多くのフィトケミカル、ポリフェノール、テルペン、タンニンが含まれています。
                [14]レモンジュースはライムジュースよりもわずかに多くのクエン酸を含んでおり（約47g / l）、グレープフルーツジュースのクエン酸の約2倍、オレンジジュースに含まれるクエン酸の約5倍です。

                CULINARY
                レモンのジュース、皮、および皮は、さまざまな食品や飲み物で使用されています。
                全レモンはマーマレード、レモンカード、レモンリキュールの製造に使用されます。
                レモンのスライスとレモンの皮は、食品や飲み物のガーニッシュとして使用されます。
                レモンの皮、果実のおろし物は、焼き菓子、プリン、ご飯、その他の料理に風味を加えるために使用されます。

                JUICE
                レモンジュースはレモネード、ソフトドリンク、カクテルの製造に使用されます。
                魚のマリネに使用され、その酸は魚のアミンを揮発しないアンモニウム塩に変換することで中和します。
                肉では、酸がタフなコラーゲン繊維を部分的に加水分解し、それを柔らかくします。
                イギリスでは、特にシローブ・チューズデーに、レモンジュースは頻繁にパンケーキに加えられます。
                レモンジュースはまた、スライスした後に酸化して茶色くなる傾向のある特定の食品（酵素による茶色くなり）であるリンゴ、バナナ、アボカドの短期間の保存料としても使用されます。
                酸は酵素を変性させます。PEELモロッコでは、レモンは塩の瓶やバレルに保存されます。
                塩は皮と皮に浸透し、それらを柔らかくして、ほとんど無期限に持続するようにします。
                保存されたレモンはさまざまな料理で使用されます。
                保存されたレモンはまた、シチリア、イタリア、ギリシャ、フランスの料理で見られます。
                皮は、食品およびその他の製品のゲル化剤および安定剤として使用される多糖類であるペクチンの製造に使用することができます。

                OIL
                レモンオイルは皮の油含有細胞から抽出されます。
                機械は細胞を壊し、油を洗い流すための水スプレーを使用します。
                油/水混合物はその後、遠心分離によってフィルタリングおよび分離されます。


                LEAVES
                レモンの木の葉は、お茶を作るためや、調理された肉や魚介類の調理に使用されます。
                """,
                nutrition: ["121 kJ (29 kcal)","2.5 g","0.3 g","1.1 g","B1, B2, B3, B5, B6, B9, C, コリン","カルシウム、鉄、マグネシウム、マンガン、リン、カリウム、ナトリウム、亜鉛"]
            ),
            .init(
                title: "Plum",
